...
\begin{frame}[t]
  ...
  \begin{figure}
    \centering
    \only<2->{\includegraphics[width=3.5cm]{c1_introduction/system_01.jpg}}\qquad
    \only<3->{\includegraphics[width=2.5cm]{c1_introduction/system_02.png}}\\
    \only<4->{\includegraphics[width=3.5cm]{c1_introduction/system_03.jpg}}\quad
    \only<5->{\includegraphics[width=3.2cm]{c1_introduction/system_04.jpg}}\quad
    \only<6->{\includegraphics[width=3.2cm]{c1_introduction/system_05.jpg}}
  \end{figure}
\end{frame}
...
生物以细胞作为生命的基本单位，基因作为遗传的基本单元，进化是推动新物种的合成和创建的引擎。所有生物体的生存以消耗和转换能量，调节体内环境以维持稳定和重要的生命条件。
  ...
  \begin{figure}
    \centering
    \only<2->{\includegraphics[width=4.5cm]{c1_introduction/organism_01.jpg}}\qquad
    \only<2->{\includegraphics[width=4cm]{c1_introduction/organism_02.png}}
  \end{figure}
\end{frame}
...
人们习惯根据研究对象的不同把科学划分为不同的类别，传统的自然科学主要有生物学、物理学、化学、地质学和天文学。逻辑学和数学的地位比较特殊，它们是其它一切科学的论证基础和工具。
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{c1_introduction/science_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/biology_01.jpg}
  \end{figure}
\end{frame}
...
现代生物学是一个庞大而兼收并蓄的领域，由许多分支和分支学科组成。生物学分支学科被研究生物体的规模和研究它们使用的方法所定义：生物化学考察生命的基本化学；分子生物学研究生物分子之间错综复杂的关系；植物学研究植物的生物学；细胞生物学检查所有生命的基本组成单位，细胞；生理学检查组织，器官，和生物体的器官系统的物理和化学的功能；进化生物学考察生命的多样性的产生过程；生态学考察生物在其环境如何相互作用。
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.28\textwidth]{c1_introduction/biology_subject_01.png}\qquad
    \includegraphics[width=0.38\textwidth]{c1_introduction/biology_subject_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/biological_hierarchy_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/reductionism_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.55\textwidth]{c1_introduction/mechanism_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \only<2->{\includegraphics[width=0.4\textwidth]{c1_introduction/gene_determinism_01.jpg}}\qquad
    \only<3->{\includegraphics[width=0.42\textwidth]{c1_introduction/epigenetics_01.jpg}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.42\textwidth]{c1_introduction/holism_01.jpg}\quad
    \includegraphics[width=0.5\textwidth]{c1_introduction/holism_03.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c1_introduction/reductionism_vs_holism_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \only<1->{\includegraphics[width=0.4\textwidth]{c1_introduction/nonscience_01.jpg}}\qquad
    \only<2->{\includegraphics[width=0.3\textwidth]{c1_introduction/liro_01.png}}\\
    \vspace{1em}
    \only<3->{\includegraphics[width=0.4\textwidth]{c1_introduction/liro_10.png}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_history_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_history_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c1_introduction/sb_content_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \only<2->{\includegraphics[width=0.8\textwidth]{c1_introduction/sb_workflow_01.jpg}}
  \end{figure}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c1_introduction/sb_workflow_07.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_workflow_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_workflow_04.jpg}
  \end{figure}
\end{frame}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=\textwidth]{c1_introduction/sb_workflow_05.png}
%   \end{figure}
% \end{frame}
%
% \begin{frame}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=0.9\textwidth]{c1_introduction/sb_workflow_06.jpg}
%   \end{figure}
% \end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_method_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c1_introduction/sb_tdbu_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_model_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.55\textwidth]{c1_introduction/sb_simulation_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_application_02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_introduction/sb_application_03.png}
  \end{figure}
\end{frame}
