...
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 术语 | PE | Power}
  \begin{figure}
    \centering
...
\subsubsection{预处理}
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 预处理 | Trim}
  \begin{figure}
    \centering
...
\subsubsection{比对后}
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 比对 | Removal of PCR duplicates}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 比对 | Indel Realignment}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 比对 | Base quality recalibration}
  \begin{figure}
    \centering
...
\subsubsection{实验设计}
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 设计 | Replicates}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 设计 | Read depth}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 设计 | Read length}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 设计 | Barcode}
  \begin{figure}
    \centering
...
\begin{frame}
  \frametitle{基因组学 | 数据分析 | 补遗 | 设计 | \textcolor{red}{KEY}}
  \begin{figure}
    \centering
