...
\parpic[fr]{\includegraphics[width=8cm]{c2_sequencing_timeline_02.png}}
\begin{enumerate}
  \item 引言与导入（5分钟）
    \begin{enumerate}
      \item 基本概念
  ...
  \item 第一代测序技术（10分钟）
\parpic[fr]{\includegraphics[width=8cm]{c2_sequencing_sanger_05.jpg}}
    \begin{enumerate}
      \item 化学测序法：化学变性
        \begin{itemize}
...
\parpic[fr]{\includegraphics[width=11cm]{c2_sequencing_ngs_01.jpg}}
        \begin{itemize}
          \item 扩增：桥式扩增
          \item 测序：边合成边测序
        \end{itemize}
    ...
    \end{enumerate}
\parpic[fl]{\includegraphics[width=5.8cm,height=8.05cm]{c2_sequencing_ill_01.png}}
\vspace{8em}
\parpic[fr]{\includegraphics[width=11cm]{c2_sequencing_compare_00.jpg}}
\vspace{0.1em}
...
\vspace{0.1em}
  \item 第三代测序技术（20分钟）
\parpic[fr]{\includegraphics[width=12cm]{c2_sequencing_compare_06.png}}
    \begin{enumerate}
      \item tSMS
      \item SMRT
      \item FRET
      ...
      \item 第三代测序技术比较
    \end{enumerate}
%\parpic[fr]{\includegraphics[width=11cm]{c2_sequencing_sms_smrt_fret_01.jpg}}
