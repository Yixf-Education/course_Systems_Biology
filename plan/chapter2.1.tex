...
\parpic[fr]{\includegraphics[width=7cm]{c2.gene.01.jpg}}
\begin{enumerate}
  \item 引言与导入（15分钟）\\
...
\parpic[fr]{\includegraphics[angle=270,origin=c,width=7cm]{c2.hgp.timeline.01.jpg}}
  \item 人类基因组计划（45分钟）
    \begin{enumerate}
