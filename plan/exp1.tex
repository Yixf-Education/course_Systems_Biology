...
\begin{enumerate}
  \item FASTQ格式（10分钟）
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.45\textwidth]{c2.format.fastq.06.png}
      \includegraphics[width=0.5\textwidth]{c2.format.fastq.11.png}
    \end{figure}
  \item 质控与预处理（10分钟）
\parpic[fr]{\includegraphics[width=8.5cm]{c2.workflow.ngs.031.png}}
    \begin{enumerate}
      \item 质量控制
        \begin{itemize}
