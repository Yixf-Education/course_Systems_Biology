...
\begin{itemize}
  ...
  \item （30'）RNA-Seq简介：介绍RNA-Seq，讲解RNA-Seq的主要技术和常见应用。
  \item （30'）RNA-Seq流程：介绍RNA-Seq的基本流程，总结实验操作与数据分析的关键步骤，讲解RNA-Seq的专用术语。
...
\begin{enumerate}
  ...
  \item 转录组学（30分钟）
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=8.8cm]{c3_omics_03.png}}
      ...
      \item 转录组学
        \begin{enumerate}
          ...
          \item 转录组学\textcolor{red}{（时空的连续性 vs. 快照，动 vs. 静；以电影和截图进行类比）}
            \begin{itemize}
\parpic[fr]{\includegraphics[width=6cm]{c3_trans_method_03.jpg}}
...
\parpic[fr]{\includegraphics[width=8cm]{c3_rs_analysis_workflow_01.png}}
  ...
  \item RNA-Seq流程（30分钟）
    \begin{enumerate}
      \item \textcolor{red}{【重点】}主要流程\textcolor{red}{（与外显子组测序进行比较）}
        ...
        \begin{figure}[h]
          \centering
          \includegraphics[width=0.45\textwidth]{c3_workflow_exp_11.jpg}
          \includegraphics[width=0.45\textwidth]{c3_workflow_tool_format_02.png}
        \end{figure}
        \vspace{-1em}
\parpic[fr]{\includegraphics[width=8cm]{c3_workflow_strand_02.png}}
      \item 相关技术
        \begin{itemize}
...
\parpic[fr]{\includegraphics[width=8cm]{c3_workflow_mirna_01.jpg}}
          \item FPKM：Fragments Per Kilobase Million
          \item TPM：Transcripts Per Kilobase Million
          \item RPKM vs. FPKM：SE vs. PE
\parpic[fl]{\includegraphics[width=6.5cm,height=1.4cm]{c3_term_tpm_03.png}}
        \end{itemize}
    \end{enumerate}
...
\otherHeader
        ...
        \begin{figure}[h]
          \centering
          \includegraphics[width=0.5\textwidth]{c3_term_fpkm_03.png}
          \includegraphics[width=0.45\textwidth]{c3_term_rpkm_03.png}
        \end{figure}
        \vspace{-1em}
        \begin{figure}[h]
          \centering
          \includegraphics[width=0.5\textwidth]{c3_term_all_02.jpg}
          \includegraphics[width=0.45\textwidth]{c3_term_all_04.jpg}
        \end{figure}
        \vspace{-1em}
