...
\begin{enumerate}
  \item 引言与导入（5分钟）
    \begin{itemize}
\parpic[fr]{\includegraphics[width=5cm]{c3_chipseq_exp_02.jpg}}
  ...
  \item 顺反组（45分钟）
    \begin{enumerate}
      ...
      \item ChIP-Seq\textcolor{red}{（与RNA-Seq进行对比）}
        \begin{enumerate}
\parpic[fr]{\includegraphics[width=9cm]{c3_chipseq_bx_04.jpg}}
          ...
          \item \textcolor{red}{【难点】}Peak calling
            \begin{itemize}
\parpic[fr]{\includegraphics[width=9cm]{c3_chipseq_pc_02.jpg}}
...
% \parpic[fr]{\includegraphics[width=9cm]{c3_epi_intro_02.jpg}}
    ...
    \begin{enumerate}
      \item 表观遗传学简介
        \begin{enumerate}
          \item 表观遗传学
            \begin{itemize}
\parpic[fr]{\includegraphics[width=6.5cm]{c3_epi_methy_01.jpg}}
      ...
      \item Methyl-Seq\textcolor{red}{（与ChIP-Seq进行类比）}
        \begin{enumerate}
\parpic[fr]{\includegraphics[width=6.5cm]{c3_mseq_bx_02.png}}
