...
\begin{enumerate}
  ...
  \item \textcolor{red}{【重点】}RNA-Seq数据分析（30分钟）
    ...
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=7.8cm]{c3.tool.pipeline.01.jpg}}
  ...
  \item \textcolor{red}{【重点，难点】}Tuxedo套装（40分钟）
    ...
    \begin{enumerate}
      \item Tuxedo简介\textcolor{red}{（讲解每个工具的作用及相互之间的联系）}
        \begin{enumerate}
\parpic[fr]{\includegraphics[width=4cm,height=10cm]{c3.tool.tc.00.png}}
      ...
      \item Tuxedo使用\textcolor{red}{（结合工具之间的关联讲解套装的使用）}
        \begin{figure}[h]
          \centering
          \includegraphics[width=0.45\textwidth]{c3.tool.tc.04.png}
          \includegraphics[width=0.5\textwidth]{c3.tool.tc.03.png}
        \end{figure}
...
\otherHeader
      ...
      \item 补遗
        \begin{itemize}
% \parpic[fr]{\includegraphics[width=8cm]{c3.workflow.test.01.png}}
          \item Multiple test: p-value vs. FDR
          \item Downstream analysis: DAVID, GSEA, GO, KEGG
        \end{itemize}
        \begin{figure}[h]
          \centering
          \includegraphics[width=0.8\textwidth]{c3.tool.tc.01.png}
        \end{figure}
    \end{enumerate}
