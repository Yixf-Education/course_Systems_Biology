...
\begin{enumerate}
  \item 分析流程（10分钟）
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.35\textwidth]{c3.workflow.bx.05.png}
      \hspace{2em}
      \includegraphics[width=0.38\textwidth]{c3.tool.tc.01.png}
    \end{figure}
...
% \parpic[fr]{\includegraphics[width=11cm,height=6cm]{c2.format.vcf.05.png}}
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.22\textwidth]{c3.tool.tc.00.png}
      \hspace{2em}
      \includegraphics[width=0.61\textwidth]{c2.format.gtf.gff.03.png}
    \end{figure}
